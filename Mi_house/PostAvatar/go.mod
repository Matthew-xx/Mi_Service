...
replace Mi_house/PostAvatar/handler => F:\Software\go_path\src\Mi_house\PostAvatar\handler

go 1.13

require (
	Mi_house/PostAvatar/handler v0.0.0-00010101000000-000000000000
